  ...
  { label: "Home", path: '/' },
  {
    ...
    subItems: [
      ...
      },
      {
        ...
        path: `/vets/in-clinic?city=${localStorage.getItem('userCity') || 'Bengaluru'}`,
        icon: BriefcaseMedical,
        description: "Book in-person appointments near you",
      },
      {
        label: "Pet Grooming",
        path: `/groomers?city=${localStorage.getItem('userCity') || 'Bengaluru'}`,
        icon: Scissors,
        description: "Professional grooming for your pet",
      },
      {
        label: "Pet Sitting",
        path:`/sitters?city=${localStorage.getItem('userCity') || 'Bengaluru'}`,
        icon: House,
